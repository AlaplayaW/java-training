public class StringTraining {
    ...
    public static String capitalize(String string) {
        ...
        //return string.charAt(0).toUpperCase() + string.substring(1); ---> NOT WORKING !!!
        //return Character.toUpperCase(string.charAt(0)) + string.substring(1) ; ---> WORKING
    }
    ...
    public static int occurrences(String string, char search) {
        // Method 1 :
        return (string.split(String.valueOf(search), -1).length ) - 1;
